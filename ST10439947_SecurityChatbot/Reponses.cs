...
{
    //-----------------------------------------------------------------------------------/
    //this class holds the responses and keywords for the chatbot
    internal class Reponses
    {
        ...
        //---------------------------------------------------------------------------------/
        //All Cybersecurity facts/responses in an array
        public String[] Responses = new String[]
        {
            "Hello {Name}, I'm doing great! Thanks for asking! ",
            "You can ask me about cybersecurity topics like phishing, malware, viruses, " +
            "passwords and more!",
            ...
            "Malware is any harmful software made to damage or steal information from " +
            "your device. Stay protected, {Name}.",
            "Spyware secretly watches what you do and can steal your passwords or personal data.",
            "Pharming redirects you to fake websites that look real so attackers can steal " +
            "your info. Always double-check those URLs, {Name}.",
            ...
            "A virus is a type of malware that spreads and harms files or programs on " +
            "your device.",
            "Hacking is when someone gains unauthorized access to systems or data. " +
            "Keep your passwords secure, {Name}.",
            "Encryption turns your information into a code so that only the right people " +
            "can read it.",
            "A data breach happens when private information is accessed or leaked " +
            "without permission.",
        ...
        //---------------------------------------------------------------------------------/
        //All Cybersecurity keywords in an array
